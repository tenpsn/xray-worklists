const dictionaries = {
  en: {
    ...
    settings: {
      ...
      modalityAetLabel: 'X-ray machine AE Title',
      modalityAetPlaceholder: 'e.g. DROC (from the X-ray machine\'s own DICOM settings)',
      modalityIpLabel: 'X-ray machine IP address',
      modalityIpPlaceholder: 'e.g. 192.168.1.50',
      modalityHint: 'Whitelists the X-ray machine so it can query the worklist. Get these from the X-ray machine\'s own network/DICOM settings screen, not from this server.',
  ...
  th: {
    ...
    settings: {
      ...
      modalityAetLabel: 'AE Title เครื่อง X-ray',
      modalityAetPlaceholder: 'เช่น DROC (ดูจากหน้าตั้งค่า DICOM ของเครื่อง X-ray เอง)',
      modalityIpLabel: 'IP เครื่อง X-ray',
      modalityIpPlaceholder: 'เช่น 192.168.1.50',
      modalityHint: 'ใช้ลงทะเบียนให้เครื่อง X-ray query worklist ได้ ดูค่าจากหน้าตั้งค่า network/DICOM ของเครื่อง X-ray เอง ไม่ใช่ของเครื่องเซิร์ฟเวอร์นี้',
